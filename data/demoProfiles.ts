...
export const demoTech: CVData = {
  ...
  educations: [
    {
      ...
      details: "Tesi su orchestrazione di microservizi edge computing.",
    },
    {
      id: "edu-tech-2",
  ...
  settings: {
    ...
    avatarSize: "md",
    sectionOrder: [
      { id: "sec-sum", key: "summary", label: "Profilo Professionale", isVisible: true, column: "main" },
      { id: "sec-exp", key: "experience", label: "Esperienze Lavorative", isVisible: true, column: "main" },
      { id: "sec-edu", key: "education", label: "Formazione & Studi", isVisible: true, column: "main" },
      { id: "sec-sk", key: "skills", label: "Competenze Tecniche & Cloud", isVisible: true, column: "main" },
      { id: "sec-pr", key: "projects", label: "Progetti Open-Source", isVisible: true, column: "main" },
...
export const demoFinance: CVData = {
  ...
  educations: [
    ...
    },
    {
      ...
      degree: "Laurea Triennale in Economia e Gestione Aziendale",
      fieldOfStudy: "Economics & Finance",
      location: "Milano",
      startDate: "2013",
      endDate: "2016",
      isCurrent: false,
  ...
  settings: {
    ...
    sectionOrder: [
      ...
      { id: "sec-exp", key: "experience", label: "Esperienza Professionale", isVisible: true, column: "main" },
      ...
      { id: "sec-sk", key: "skills", label: "Competenze & Modellazione Finanziaria", isVisible: true, column: "main" },
...
export const demoHumanities: CVData = {
  ...
  educations: [
    ...
    },
    {
      ...
      degree: "Laurea Magistrale in Storia dell'Arte Contemporanea",
      fieldOfStudy: "Arti Visive",
      location: "Bologna",
      startDate: "2013",
      endDate: "2015",
      isCurrent: false,
    ...
    },
    {
      ...
      degree: "Laurea Triennale in Lettere e Beni Culturali",
      fieldOfStudy: "Lettere Classiche & Storia dell'Arte",
      location: "Siena",
      startDate: "2010",
      endDate: "2013",
      isCurrent: false,
  ...
  settings: {
    ...
    sectionOrder: [
      ...
      { id: "sec-exp", key: "experience", label: "Esperienza Professionale & Incarichi", isVisible: true, column: "main" },
...
export const demoDesign: CVData = {
  ...
  educations: [
    {
      ...
      degree: "Master Universitario in Service & Interaction Design",
    ...
    },
    {
      id: "edu-des-2",
      institution: "Politecnico di Torino",
      degree: "Laurea Triennale in Design e Comunicazione Visiva",
      fieldOfStudy: "Industrial & Visual Design",
      location: "Torino",
      startDate: "2014",
      endDate: "2017",
      isCurrent: false,
  ...
  skillCategories: [
    { id: "cat-d1", name: "Design & Prototyping", skills: ["Figma (Variables)", "Framer", "Design Tokens", "Protopie", "Adobe CC"] },
  ...
  settings: {
    ...
    sectionOrder: [
      ...
      { id: "sec-edu", key: "education", label: "Percorso Accademico & Master", isVisible: true, column: "main" },
...
export const demoHealthcare: CVData = {
  ...
  educations: [
    {
      id: "edu-med-1",
      institution: "Alma Mater Studiorum — Università di Bologna",
      degree: "Diploma di Specializzazione in Malattie dell'Apparato Cardiovascolare",
  ...
  settings: {
    ...
    avatarSize: "sm",
    sectionOrder: [
      { id: "sec-sum", key: "summary", label: "Profilo Medico-Scientifico", isVisible: true, column: "main" },
      { id: "sec-exp", key: "experience", label: "Esperienza Professionale & Clinica", isVisible: true, column: "main" },
...
export const demoProfiles: DemoProfile[] = [
  {
    ...
    emoji: "💻",
    tagline: "Minimal Monocromatico • Cloud & DevOps • Laurea Triennale + Magistrale 110L",
    data: demoTech,
  },
  {
    id: "finance",
    ...
    emoji: "📊",
    tagline: "Executive Warm • Deals M&A & Modellazione DCF • Bocconi 110L + Cattolica 108",
    data: demoFinance,
  },
  {
    id: "humanities",
    ...
    emoji: "✍️",
    tagline: "Nordic Slate • Dottorato Ph.D. con Lode • Monografie & 4 Lingue",
    data: demoHumanities,
  },
  {
    id: "design",
    ...
    emoji: "🎨",
    tagline: "Modern Sidebar • Master Magna Cum Laude + Triennale 105 • Premi Red Dot",
    data: demoDesign,
  },
  {
    id: "healthcare",
    ...
    emoji: "🩺",
    tagline: "Forest Professional • Specializzazione 50/50L + Medicina 110L • Trial Clinici",
    data: demoHealthcare,
  },
];
